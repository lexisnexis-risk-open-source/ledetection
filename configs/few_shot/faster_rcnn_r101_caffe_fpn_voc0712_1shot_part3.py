...
CLASSES = (
    "aeroplane", "bicycle", "bird", "bottle", "bus", "car", "chair",
    "cow", "diningtable", "dog", "horse", "person", "pottedplant",
...
lr_config = dict(step=[9000])
runner = dict(_delete_=True, type="IterBasedRunner", max_iters=10000)
checkpoint_config = dict(by_epoch=False, interval=1000, max_keep_ckpts=1)
auto_resume = False
fp16 = dict(loss_scale="dynamic")
load_from = "results/voc0712_base15/part3/${model_type}/r101/model_reset_surgery.pth"

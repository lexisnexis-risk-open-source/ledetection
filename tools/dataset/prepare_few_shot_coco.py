# Modified from
# https://github.com/ucbdrive/few-shot-object-detection/blob/master/datasets/prepare_coco_few_shot.py
import argparse
import json
import os
import random
...
def generate_seeds(args):
    if args.save_dir == "":
        # By default, save to same directory as args.data_path
...
def get_save_path_seeds(save_dir, cls, shots, seed):
    prefix = "full_box_{}shot_{}_trainval".format(shots, cls)
    save_dir = os.path.join(save_dir, "cocosplit2017", "seed" + str(seed))
